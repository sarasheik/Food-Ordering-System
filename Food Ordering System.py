...
btnTotal=Button(f1right,padx=16,pady=8,bd=16,fg="black",font=('arial',16,'bold'),width=10,text="Total",bg="powder blue",command=code.total).grid(row=4,column=0)
btnReset=Button(f1right,padx=16,pady=8,bd=16,fg="black",font=('arial',16,'bold'),width=10,text="Reset",bg="aquamarine",command=code.reset).grid(row=5,column=0)
btnExit=Button(f1right,padx=16,pady=8,bd=16,fg="black",font=('arial',16,'bold'),width=10,text="Exit",bg="red",command=code.qexit).grid(row=6,column=0)
root.mainloop()
